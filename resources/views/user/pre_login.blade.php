...
<div class="body-content">
    <div class="login-content">
    	<div class="card-no-bg-mobile">
            ...
            <a class="btn-border" id="modal-toggle" data-toggle="modal" data-target="#modalOTP">Tiếp tục</a> 
        </div>

        <div class="modal fade" id="modalOTP" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        <h3 class="title">Nhập mã xác nhận</h3>
                        <p>Mã xác nhận 6 chữ số chúng tôi đã gửi đến số điện thoại: <span id="js-phone-number-otp"></span></p>
                        ...
                        <p>Mã OTP hết hạn sau <span id="js-time-remain-otp">30</span>s</p>
                    </div>
